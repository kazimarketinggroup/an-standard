...
export const metadata: Metadata = {
  title: 'Quilting For The Equestrian Sector — A.N. Standard Ltd.',
  description:
    'Equestrian products carry the heaviest waddings we quilt and live outdoors. The pattern has to be large enough not to crush the loft.',
}

// Folder name is capitalised on disk; paths are case-sensitive in production.
const IMG = '/images/Equestrian'

export default function EquestrianSectorPage() {
  return (
    <SectorDetail
      currentHref="/sectors/equestrian"
      accent="Equestrian"
      intro="Heavy use, weather, high wadding weights."
      heroImage={{
        src: `${IMG}/Rectangle 95.png`,
        alt: 'A rider fitting a navy quilted saddle pad to a bay horse',
      }}
      sectionTitle="What Equestrian Manufacturers Need From Quilting"
      paragraphs={[
        'Equestrian products carry the heaviest waddings we quilt and live outdoors. The pattern has to be large enough not to crush the loft, and the stitch has to survive weather and hard use.',
      ...
      banner={{
        heading: 'Fabrics we quilt for equestrian',
        body: [
          'Ripstop nylon, canvas and waterproof-backed fabrics.',
      ...
      evidence={{
        ...
        image: {
          ...
          alt: 'Close-up of pale blue channel-quilted padded fabric',
        },
      }}
      relatedHrefs={[
