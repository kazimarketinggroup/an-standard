...
export const metadata: Metadata = {
  title: 'Quilting For The Clothing Sector — A.N. Standard Ltd.',
  description:
    'We quilt wax fabric — a genuine speciality, and one most commission quilters will not take on — alongside shell fabrics for outerwear on seasonal lead times.',
}

const IMG = '/images/clothing'

export default function ClothingSectorPage() {
  return (
    <SectorDetail
      currentHref="/sectors/clothing"
      accent="Clothing"
      intro="Fashion-led, seasonal, wax fabric a stated speciality."
      heroImage={{
        src: `${IMG}/Rectangle 96.png`,
        alt: 'A showroom of patterned dresses and printed fabric bolts',
      }}
      sectionTitle="What Clothing Manufacturers Need From Quilting"
      paragraphs={[
        'We quilt wax fabric — a genuine speciality, and one most commission quilters will not take on. Wax cotton behaves differently under the needle and needs the right needle, tension and handling to come off the machine without marking. Alongside that we quilt shell fabrics for outerwear on seasonal lead times.',
      ...
      banner={{
        heading: 'Fabrics we quilt for clothing',
        body: [
          'Wax cotton, nylon and polyester shell fabrics.',
      ...
      evidence={{
        ...
        image: {
          ...
          alt: 'Close-up of olive and bronze diamond-quilted shell fabric',
        },
      }}
      relatedHrefs={[
